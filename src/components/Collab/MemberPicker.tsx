    ...
    <div className="fixed inset-0 bg-black/30 z-[60]" onClick={onClose}>
      ...
      >
        <div className="flex items-center justify-between px-3 py-2 border-b">
          ...
          <button onClick={onClose} className="px-2 py-1 rounded hover:bg-gray-100 text-gray-600">✕</button>
        </div>
        <div className="p-3">
          <input
            value={q}
            ...
            className="w-full border rounded px-2 py-1 mb-2 text-gray-900 placeholder-gray-400"
          />
              ...
              <li key={m.id}>
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="font-medium text-gray-900">{m.name} <span className="text-xs text-gray-500">· {m.role}</span></div>
